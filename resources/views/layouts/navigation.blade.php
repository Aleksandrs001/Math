            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <div class="text-gray-400">
                        <a href="{{ route('change.locale', ['locale' => 'en']) }}" style="{{ app()->getLocale() === 'en' ? 'color: #BDBDBD;' : 'color: #808080;' }}">English</a> |
                        <a href="{{ route('change.locale', ['locale' => 'ru']) }}" style="{{ app()->getLocale() === 'ru' ? 'color: #BDBDBD;' : 'color: #808080;' }}"> Русский</a> |
                        <a href="{{ route('change.locale', ['locale' => 'lv']) }}" style="{{ app()->getLocale() === 'lv' ? 'color: #BDBDBD;' : 'color: #808080;' }}"> Latviešu</a>
